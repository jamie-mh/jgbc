...
// IMGUI_DISABLE_WIN32_DEFAULT_IME_FUNCTIONS         // [Win32] Don't implement default IME handler. Won't use and link
// with ImmGetContext/ImmSetCompositionWindow. #define IMGUI_DISABLE_WIN32_FUNCTIONS                     // [Win32]
// Won't use and link with any Win32 function (clipboard, ime). #define IMGUI_ENABLE_OSX_DEFAULT_CLIPBOARD_FUNCTIONS //
// [OSX] Implement default OSX clipboard handler (need to link with '-framework ApplicationServices'). #define

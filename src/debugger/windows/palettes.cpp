    ...
    for (auto palette = 0; palette < 8; ++palette) {
        ...
        for (auto type = 0; type < 2; ++type) {
            ...
            for (auto i = 0; i < 4; ++i) {
                ...
                const auto colour = type == 0 ? debugger().gb()->ppu.bg_palette[palette * 4 + i]
                ...
                ImGui::ColorButton("##button", colour_vec, ImGuiColorEditFlags_NoAlpha | ImGuiColorEditFlags_NoPicker,
                                   ImVec2(30, 30));
            }
